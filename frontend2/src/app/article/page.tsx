      ...
      <div className="relative overflow-hidden pb-6 pt-12 border-b border-neutral-900 bg-[#0d0d0d]">
        ...
        <div className="container mx-auto px-6 max-w-6xl relative z-10">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-900/20 border border-blue-800/30 text-blue-400 text-xs font-bold tracking-widest uppercase mb-5">
              <span className="material-icons-outlined text-sm">article</span>
              Articles & News
            </div>
            <h1 className="text-4xl md:text-5xl font-black text-neutral-100 uppercase tracking-tighter">
              บทความ & ข่าวสาร
            </h1>
          </div>

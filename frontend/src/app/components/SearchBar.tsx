...
import { fetchSearchRecommendations, imgUrl, formatDate, Post } from '../(main)/search/api';
    ...
    <div ref={containerRef} className={`relative ${className}`} style={{ transform: 'translateZ(0)' }}>
      ...
      >
        <input
          ...
          autoFocus={autoFocus}
          className={`w-full pl-0 md:pl-4 focus:pl-4 pr-0 md:pr-10 focus:pr-10 py-1.5 bg-neutral-800 border border-neutral-700 text-transparent md:text-neutral-100 focus:text-neutral-100 placeholder-transparent md:placeholder-neutral-400 focus:placeholder-neutral-400 text-sm rounded-full focus:outline-none focus:border-neutral-400 transition-colors cursor-pointer md:cursor-text focus:cursor-text ${inputClassName}`}

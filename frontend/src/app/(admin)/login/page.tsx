...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f7f9] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row max-w-4xl w-full mx-auto my-4">
        {/* Left Side: Logo */}
        <div className="md:w-1/2 p-8 md:p-12 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-gray-100 bg-[#fafcff]">
        ...
        <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
          <div className="text-center mb-8">
            <h1 className="text-3xl md:text-4xl font-black text-gray-800 mb-1">Admin :</h1>
            <h2 className="text-3xl md:text-4xl font-black text-blue-600">U44Tech</h2>
          </div>
